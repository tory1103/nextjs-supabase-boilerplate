...
//
// type Action = typeof usersService.delete;
//
...
// 	return {
// 		success: true,
// 		data: await usersService.delete(data),
// 	};
// };
//
// export const usersDeleteAction = async (...args: Input): Promise<Output> => {
...
// 	if (!guards.success) {
// 		throw new Error(`ERROR: Delete ${SCOPE} guards`);
// 	}
//
