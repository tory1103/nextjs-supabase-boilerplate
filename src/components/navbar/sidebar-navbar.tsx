...
import { type NavbarNavigationMenuItem } from '@/components/navbar/navbar';
...
export default function SidebarNavbar(props: SidebarNavbarProps) {
	...
	return (
		<div
			className={`fixed top-0 start-0 ${isOpen ? 'translate-x-0' : '-translate-x-full'} w-[80vw] h-dvh z-50
